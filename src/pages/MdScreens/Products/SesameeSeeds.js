...
const SesameeSeeds = () => {
    ...
    const recievedData = [
        {
            productname: 'NO 2 Sesame Seed Bag',
            productid: 'P-001',
            lot: '74 Kg',
  ...
  return (
    <div>
        <div className="panel-header">Rejected Seeds</div>
        <div className="df df-sb">
            <div>No.2 Product / Sesamee Seeds</div>
            <button className='btn blue-btn' onClick={() => navigate('/panel/sesameeseedsform')}>+ Add Product</button>
        </div>
