...
const DPEntry = () => {
    ...
    const [IslooryTab, setIslooryTab] = useState(false);
    const navigation = useNavigate();
    useEffect(() => {
        console.log(location.state,"Location")
        if (location.state) {
            setDp(location.state);
            ...
            <div className="theme-card">
                ...
                <div className="theme-card-content df fw">
                    <div className="form-group ">
                        ...
                        <input type="text" className="form-control" readOnly   value={dp?.batchNo}/>
                    </div>
                    <div className="form-group ">
                        <label className="form-label">Referance Number :</label>
                        <input type="text" className="form-control" readOnly value={dp?.referenceNo}/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group ">
                        ...
                        <input type="text" className="form-control" value={dp?.storageDate} readOnly/>
                    </div>
                    <div className="form-group">
                           <p>Lorry Fright</p>
                                <input type="radio" id="yes" name="age" value="yes" onChange={(e)=>lorryFright(e)}/>
                                <label for="yes" className='yes'>yes</label>
                                <input type="radio" id="No" name="age" value="no" onChange={(e)=>lorryFright(e)}/>
