...
import './Journal.scss'
import SesameCleaningTab1 from './sesamecleaningtab-1'
import SesameCleaningTab2 from './sesamecleaningtab-2'
import { BsPrinter } from "react-icons/bs";

const JournalSesameCleaning = () => {
          ...
          <div className='billreceive-detail'>
            ...
            <div className='billdetail-right'>
              <div className='receiveform'>
                ...
                <div className='detail-receivebill-2'>
                  <p>11 Aug 2022</p>
                  <p>Sesame Seeds Cleaning Process</p>
                  <p>Canteen</p>
                  <p>2000 liter</p>
                  <p>Accounted</p>
                  <p>Suresh kumar</p>
...
export default JournalSesameCleaning;